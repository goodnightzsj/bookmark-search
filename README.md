...
### v1.6 - 主题系统优化与界面美化
- 🎨 **主题系统升级**：彻底重构主题切换机制，采用页面刷新策略，彻底解决样式残留和深色模式字体问题
- ⚡ **性能与安全**：移除内联脚本，完全符合 CSP V3 安全规范；优化加载逻辑防止闪烁
- 🖱️ **UI细节优化**：全套主题适配的滚动条美化，优化历史记录列表的视觉体验
- 🐛 **问题修复**：修复深色模式下部分文字颜色未更新的问题；修复设置页面部分 DOM 元素未正确初始化的问题
